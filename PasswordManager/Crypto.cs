...
namespace PasswordManager
{
    public class Crypto
    {
        private static String ss = "KFDMV2-JJ33SO-AWGNI3-33K5O3-A$$CHEE";
        private static byte[] salt()
        { 
        string keyString = @"C@RL0$123!"; // Your Key Here
        ...
        {
            return EncryptStringAES(pass, ss);
        }
        public String Decrypt(String cipher)
        {
            return DecryptStringAES(cipher, ss);
        }
